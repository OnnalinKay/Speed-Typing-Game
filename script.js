...
const words =["Blockchain","Ether","Airdrop","DAO","Dapp","Minting","Mining","WAGMI","NFT","Bullish","Bridge","DeFi","Coin","Crypto","DEX","Uniswap","Fiat","FOMO","Gas","Gwei","Hash","Metaverse","Moon","Node","Protocol","Chain","Solidity","Wallet","Oracle","LW3ROCKS","MetaMask","Alchemy","Hardhat","Guild","Parachain","Layers","Chainlink","DeWi","Yields","web3","Polygon","Solana","Hackathon"];
